		...
		<section className='min-h-[80vh] flex flex-col justify-center items-center text-center px-4 bg-gradient-to-b from-mint-50 to-white'>
			<div className='max-w-4xl mx-auto animate-fade-up'>
				...
				<p className='text-xl md:text-2xl text-gray-600 mb-8'>
					A platform that connects underprivileged individuals with relevant government
					benefits, faster.
				</p>
				<div className='space-x-4'>
					<Button
						size='lg'
						className='bg-mint-200 hover:bg-mint-300 text-navy-800'
						onClick={() =>
							window.open(
								'https://github.com/Ztrimus/gov-benefit-llama-hack',
								'_blank'
							)
						}
					>
					...
					<Button
						...
						onClick={() =>
							window.open(
								'https://youtu.be/jLphWh1i8cQ?si=QVimAyIJdQe0fl13',
								'_blank'
							)
						}
					>
